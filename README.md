...
We relied on the official IRC documentation to find and correctly implement numeric replies and error codes (such as 001–004 for welcome messages, 3xx replies and 4xx error responses), ensuring compliance with the protocol.
